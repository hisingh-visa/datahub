...
public class SearchableRefAnnotation {
    ...
    private static final Set<SearchableAnnotation.FieldType> DEFAULT_QUERY_FIELD_TYPES =
            ImmutableSet.of(SearchableAnnotation.FieldType.TEXT, SearchableAnnotation.FieldType.OBJECT, SearchableAnnotation.FieldType.TEXT_PARTIAL,
                    SearchableAnnotation.FieldType.WORD_GRAM, SearchableAnnotation.FieldType.URN, SearchableAnnotation.FieldType.URN_PARTIAL);
...
//    }
    ...
    public static SearchableRefAnnotation fromPegasusAnnotationObject(@Nonnull final Object annotationObj,
        ...
        final SearchableAnnotation.FieldType resolvedFieldType = getFieldType(fieldType, schemaDataType);
